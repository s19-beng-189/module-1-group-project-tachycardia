%filename: in_LV_sa_new.m  (initialization for LV_sa)
...
PLA=(5*.8)*1.35;        %Left atrial pressure (mmHg) decrease 20%
...
PLV=(5*0.8)*1.35;                    %Initial value of PLV (mmHg) decrease 20%
