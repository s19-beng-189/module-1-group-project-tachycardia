...
M = 0.250*(2/3); %L/min reduced by a third - old age
...
Csa=(0.00175*127/192)/2;  %Systemic arterial compliance (liters/mmHg) decreased for old age
...
PLA=5*.73;        %Left atrial pressure (mmHg) decrease 20%
...
PLV=5*.8;                    %Initial value of PLV (mmHg) decreased as result of old age
Psa=72;                   %decreased with change in ESP/EDP (mmHg)
